function [f,g,Dh]=objectiveLaplaceSquared(x,M,F,y,reg,bias,gain)
    %{
    ...
    actually, just use the expected NLL estimators with variance set to 0
    adfdfgdfgsdgdgsdgf
