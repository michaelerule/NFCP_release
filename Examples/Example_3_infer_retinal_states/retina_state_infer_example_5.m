...
%    Q  A R1 R2 rate
    -1  1  0  0 0     % spontaneous excitation 
     0 -1  1  0 15    % enter slow refractory loop
     0  0 -1  1 0.15  % slow refractory recovery
     1  0  0 -1 0.15  % slow refractory recovery
     ];
model.cscale        = [1 4 1 1];
