...
%{
Key parameters that have been changed

Activation threshold (thr) and excitatory rate (rAA) have been doubled, to
20 and 0.2, respectively. 

Active to refractory rate (second rate in model.description) has been changed from
1.8 to 10

Slow recovery rate (third rate in model.description) has been changed from
0.1 to 0.5
%}
...
yticks([])
saveas(gcf,'Inferred_statistics_A_incorrect_parameters.svg');
